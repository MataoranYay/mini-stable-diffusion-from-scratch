...
class VAELoss(nn.Module):
    ...
    def __init__(
        ...
        kl_weight: float = 0.000001,  # SD VAE uses tiny KL weight — reconstruction quality prioritized, latent not forced to 𝒩(0, I).
        device: str = "cuda",
    ):
        super().__init__()
...
class VAETrainer():
    def __init__(self,
        ...
        ##### 4. Show the first three pictures 
    ...
    def train_epoch(self):
        ...
        for batch in progress_bar:     
            ...
            with autocast('cuda'):
                # Encode
                latent = self.encoder(images, noise)  # (B, 4, H/8, W/8)
                # Decode
